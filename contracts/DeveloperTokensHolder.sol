...
/*
    Copyright 2017, DeveloperTokenHolder-overriding for injoin(injoin Research & Development)
*/
...
contract DevTokensHolder is Owned {
    ...
    InjoinContribution contribution;
    MiniMeToken iii;

    function DevTokensHolder(address _owner, address _contribution, address _iii) {
        owner = _owner;
    ...
    function collectTokens() public onlyOwner {
        uint256 balance = iii.balanceOf(address(this));
        ...
        assert(iii.transfer(owner, canExtract));
